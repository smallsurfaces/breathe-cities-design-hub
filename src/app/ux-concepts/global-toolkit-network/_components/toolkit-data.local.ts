/**
 * toolkit-data.local.ts -- Static illustrative data for the catalogue sketch panels.
 *
 * Purpose: Concept-local vendored copy for the global-toolkit-network concept (promotion to client
 * review hub, 2026-06-29): the concept stands alone with zero dependency on any sibling `toolkit`
 * concept or the shared toolkit-data module. Per-city data powering all 8 tool-panel sketches.
 * Each city has a different profile — active/dim panels, sensor counts, source breakdowns, AQI
 * values, forecasts, alerts, actions, and data samples. All data is illustrative (not live).
 * Verbatim copy of the source data — no behavioural changes; this file has no imports to repoint.
 *
